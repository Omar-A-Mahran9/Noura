            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row) {
                        if (data == 1) return __("available");
                        else return __("unavailable");
                    },
                },
                {
                    targets: 2,
                ...
                },
                {
                    targets: 7,
                    render: function (data, type, row) {
                        return `<a href="/dashboard/applicants?career_id=${
                            data.id
                        }" target="_blank" >${__("applicants")}</a>`;
                    },
                },
                {
                    targets: -1,
