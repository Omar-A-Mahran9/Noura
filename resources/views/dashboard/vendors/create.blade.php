...
@section('content')
    ...
    <div class="toolbar">
        ...
        <div class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!-- begin :: Title -->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1"><a href="{{ route('dashboard.vendors.index') }}" class="text-muted text-hover-primary">{{ __("Vendors") }}</a></h1>
                <!-- end   :: Title -->
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.vendors.store') }}" class="form" method="post" id="submitted-form" data-redirection-url="{{ route('dashboard.vendors.index') }}">
                @csrf
                <!-- begin :: Card header -->
                ...
                <div class="inputs-wrapper">
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-3 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="another_phone_inp" name="another_phone" placeholder="example"/>
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <select class="form-select"  name="status" id="status-sp" data-placeholder="{{ __("Choose the status") }}" data-dir="{{ isArabic() ? 'rtl' : 'ltr' }}"  >
                                <option value=""></option>
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <select class="form-select"  name="type" id="type-sp" data-placeholder="{{ __("Choose the type") }}" data-dir="{{ isArabic() ? 'rtl' : 'ltr' }}"  >
                                <option value=""></option>
                    ...
                    <div class="row mb-8">
                        ...
                        <!-- begin :: Column -->
                        <div class="col-md-6 fv-row" style="display: none;" id="commercial_container">
                            <label class="fs-5 fw-bold mb-2">{{ __("Commercial registration no") }}</label>
                            <div class="form-floating">
                                <input type="text" class="form-control" id="commercial_registration_no_inp" name="commercial_registration_no" placeholder="example"/>
                        ...
                        <!-- begin :: Column -->
                        <div class="col-md-6 fv-row" id="identity_container">
                            <label class="fs-5 fw-bold mb-2">{{ __("Identity no") }}</label>
                            <div class="form-floating">
                                <input type="text" class="form-control" id="identity_no_inp" name="identity_no" placeholder="example"/>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="google_maps_url_inp" name="google_maps_url" placeholder="example"/>
