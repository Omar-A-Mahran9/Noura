...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.consultation_time.store') }}" class="form" method="post"
                id="submitted-form" data-redirection-url="{{ route('dashboard.consultation_time.index') }}">
                @csrf
                <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark">{{ __('Add new consultation') }}</h3>
                </div>
                <!-- end   :: Card header -->
                        ...
                        <div class="col-md-3 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="title_ar_inp" name="title_ar"
                                    placeholder="example" />
                                <label for="title_ar_inp">{{ __('Enter the consultation title') }}</label>
                            </div>
                        ...
                        <div class="col-md-3 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="title_en_inp" name="title_en"
                                    placeholder="example" />
                                <label for="title_en_inp">{{ __('Enter the consultation title') }}</label>
                            </div>
