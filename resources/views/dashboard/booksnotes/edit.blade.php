                    ...
                    <div class="row mb-8">
                            ...
                            <div class="col-md-4 fv-row">
                                ...
                                <div class="form-floating">
                                    <input type="number" class="form-control" name="page" id="page_inp"
                                        value="{{ old('page', $note->page) }}" placeholder="e.g. 12">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6 fv-row">
                                ...
                                <textarea name="text" id="text_inp" rows="3" class="form-control" placeholder="{{ __('Enter the text') }}">{{ old('text', $note->text) }}</textarea>
                            ...
                            <div class="col-md-6 fv-row {{ $note->question ? 'd-none' : '' }}" id="note_section">
                                ...
                                <textarea name="note" id="note_inp" rows="3" class="form-control" placeholder="{{ __('Enter the note') }}">{{ old('note', $note->note) }}</textarea>
                        ...
                        <div class="row mb-4 {{ $note->question ? '' : 'd-none' }}" id="qa_section">
                            <div class="col-md-6 fv-row">
                                ...
                                <textarea name="question" id="question_inp" rows="3" class="form-control"
                                    placeholder="{{ __('Enter the question') }}">{{ old('question', $note->question) }}</textarea>
